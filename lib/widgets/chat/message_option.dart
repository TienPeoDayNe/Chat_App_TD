...
import 'package:chatapptienduy/models/message_model.dart';
import 'package:chatapptienduy/services/auth_service.dart';
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  _ReactionButton(
                      '❤️', () => onReaction(message.messageId, '❤️')),
                  _ReactionButton(
                      '👍', () => onReaction(message.messageId, '👍')),
                  _ReactionButton(
                      '😆', () => onReaction(message.messageId, '😆')),
                  _ReactionButton(
                      '😮', () => onReaction(message.messageId, '😮')),
